...
let
  ...
  patches = [
    ...
    (fetchurl {
      url = "https://git.savannah.gnu.org/cgit/guix.git/plain/gnu/packages/patches/glibc-boot-2.2.5.patch?id=50249cab3a98839ade2433456fe618acc6f804a5";
    ...
    (fetchurl {
      url = "https://git.savannah.gnu.org/cgit/guix.git/plain/gnu/packages/patches/glibc-bootstrap-system-2.2.5.patch?id=50249cab3a98839ade2433456fe618acc6f804a5";
...
bash.runCommand "${pname}-${version}" {
  ...
  # Configure
  export CC="gcc -D MES_BOOTSTRAP=1 -D BOOTSTRAP_GLIBC=1 -L $(pwd)"
  export CPP="gcc -E -D MES_BOOTSTRAP=1 -D BOOTSTRAP_GLIBC=1"
  bash ./configure \
