...
let
  ...
  */
  ...
  make_SOURCES = lib.splitString " " (
    "src/ar.c src/arscan.c src/commands.c src/default.c src/dir.c src/expand.c "
    + "src/file.c src/function.c src/getopt.c src/getopt1.c src/guile.c src/hash.c "
    + "src/implicit.c src/job.c src/load.c src/loadapi.c src/main.c src/misc.c "
    + "src/output.c src/read.c src/remake.c src/rule.c src/shuffle.c src/signame.c "
    + "src/strcache.c src/variable.c src/version.c src/vpath.c");
