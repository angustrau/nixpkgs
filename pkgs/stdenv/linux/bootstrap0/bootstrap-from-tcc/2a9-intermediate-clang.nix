  ...
  mkDerivationStage2 {
    ...
    script = ''
      ...
      # fixup:
        ...
        echo 'echo i686-unknown-linux-musl' > llvm/cmake/config.guess
      ...
      # configure:
          ...
          add_opt LLVM_DEFAULT_TARGET_TRIPLE=i686-unknown-linux-musl
          add_opt LLVM_HOST_TRIPLE=i686-unknown-linux-musl
          add_opt COMPILER_RT_DEFAULT_TARGET_TRIPLE=i686-unknown-linux-musl
      ...
      # build:
        ...
        NEW_LIB_DIR="$(pwd)/build/lib/i686-unknown-linux-musl"
      ...
      # install:
        ...
        ln -s $out/lib/i686-unknown-linux-musl/* $out/lib/
