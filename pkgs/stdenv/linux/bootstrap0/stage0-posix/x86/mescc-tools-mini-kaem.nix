...
# https://github.com/oriansj/stage0-posix-x86/blob/eeb76fc38ec4f69c0e67191e31945e1a758bb8c4/mescc-tools-mini-kaem.kaem
...
rec {
  ...
  blood-elf-0_M1 = run "blood-elf-0.M1" M2 [
    "--architecture" "x86"
    "-f" "${src}/M2libc/x86/linux/bootstrap.c"
  ...
  blood-elf-0-0_M1 = run "blood-elf-0-0.M1" catm [out "${src}/M2libc/x86/x86_defs.M1" "${src}/M2libc/x86/libc-core.M1" blood-elf-0_M1];
  blood-elf-0_hex2 = run "blood-elf-0.hex2" M0 [blood-elf-0-0_M1 out];
  blood-elf-0-0_hex2 = run "blood-elf-0-0.hex2" catm [out "${src}/M2libc/x86/ELF-x86.hex2" blood-elf-0_hex2];
  ...
  M1-macro-0-0_M1 = run "M1-macro-0-0.M1" catm [out "${src}/M2libc/x86/x86_defs.M1" "${src}/M2libc/x86/libc-core.M1" M1-macro-0_M1 M1-macro-0-footer_M1];
  M1-macro-0_hex2 = run "M1-macro-0.hex2" M0 [M1-macro-0-0_M1 out];
  M1-macro-0-0_hex2 = run "M1-macro-0-0.hex2" catm [out "${src}/M2libc/x86/ELF-x86-debug.hex2" M1-macro-0_hex2];
  ...
  hex2_linker-0_M1 = run "hex2_linker-0.M1" M2 [
    ...
    "-f" "${src}/M2libc/x86/linux/unistd.c"
    "-f" "${src}/M2libc/x86/linux/fcntl.c"
    "-f" "${src}/M2libc/x86/linux/sys/stat.c"
  ...
  hex2_linker-0_hex2 = run "hex2_linker-0.hex2" M1-0 [
    "--architecture" "x86"
    "--little-endian"
    "-f" "${src}/M2libc/x86/x86_defs.M1"
    "-f" "${src}/M2libc/x86/libc-full.M1"
    "-f" hex2_linker-0_M1
    "-f" hex2_linker-0-footer_M1
    "-o" out
  ];

  hex2_linker-0-0_hex2 = run "hex2_linker-0-0.hex2" catm [out "${src}/M2libc/x86/ELF-x86-debug.hex2" hex2_linker-0_hex2];
  ...
  M1 = run "M1" hex2-1 [
    ...
    "-f" "${src}/M2libc/x86/ELF-x86-debug.hex2"
    "-f" M1-macro-1_hex2
    "-o" out
  ];
